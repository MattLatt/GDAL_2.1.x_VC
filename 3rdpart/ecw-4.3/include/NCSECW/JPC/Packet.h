...
public:
	...
	virtual ~CPacketList();
		 ...
		 * @return      CError	NCS_SUCCESS, or Error code on failure.
		 */
	//virtual CError Parse(class CJPC &JPC, CIOStream &Stream, bool &bComplete, UINT64 nBytes, INT32 nHeaders = -1);
	virtual CError Parse(class CJPC &JPC, CIOStream &Stream, class CTilePartHeader *pMainTP, bool &bComplete, UINT64 nBytes, INT32 nHeaders = -1); // not to use m_pCurrentTilePart 12/07/2012
		 ...
		 * @return      CError	NCS_SUCCESS, or Error code on failure.
		 */
	virtual CError ParseHeader(class CTilePartHeader *pMainTP, bool &bComplete, UINT32 nCurPacket);	// not to use m_pCurrentTilePart 12/07/2012
	virtual CError GenDynamicPLTs(class CTilePartHeader *pMainTP);
		/** 
