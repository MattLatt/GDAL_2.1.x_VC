...
public:
	...
	static UINT8 CalculateResolutionLevel(CComponent *pComponent, INT32 nTopX, INT32 nLeftY, INT32 nBottomX, INT32 nRightY, UINT32 nSizeX, UINT32 nSizeY);
...
private:
	...
	bool ReadTilePartInfo(ContextID nCtx, NCS::JPC::CJPC &JPC, bool bLinkTile = false);// Against bug EMS-407, added 08/12/2011
...
protected:
	...
	CNode2D *BuildInputChain(ContextID nCtx, CJPC &JPC, CView *pFileView, UINT16 iComponent, UINT16 iChannel, JP2::CFile::CHeaderBox &Header, CTilePartHeader *pTilePart, bool bCreatePacketsAllowed); // changed on 20/12/2011
		/** 
	...
	bool LinkTile(ContextID nCtx, CTilePartHeader *pTilePart, JP2::CFile::CHeaderBox &Header,
		  Context::TileInput &ioTI, bool bCreatePacketsAllowed = true); // Against bug EMS-407, added 14/12/2011

	bool LinkTile(ContextID nCtx, UINT16 iComponent, UINT16 iChannel, CTilePartHeader *pTilePart, JP2::CFile::CHeaderBox &Header,
		Context::TileInput &ioTI, bool bCreatePacketsAllowed);  // Against bug EMS-407, added 14/12/2011
