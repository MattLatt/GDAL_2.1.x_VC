...
//	NCS_FILE_HANDLE	outfile;					/* output file */
	...
	NCSFileViewFileInfoEx	*pFileInfo;			// Valid at top level only
...
extern NCSError setup_qmf_tree(QmfLevel **pp_qmf, struct EcwCompressionTask *pCompressionTask,
						  ...
						  IEEE4 compression_factor, CompressFormat compress_format, int compress, bool write_non_opacity, bool write_opacity );
#endif
...
extern NCSError	build_qmf_compress_file(QmfLevel *p_top_qmf, NCS::CIOStream *pStream);
...
NCSError write_compressed_preamble(QmfLevel *p_top_qmf, NCS::CIOStream *pStream);
...
extern QmfLevel *erw_decompress_open(
			...
			NCS::CError &eError );		//Error for checking ECW version 
