...
typedef struct NCSEcwCompressClient {
	...
	*/
	 ...
	 */
	wchar_t	szInputFilename[MAX_PATH];			
...
/** 
 *	Call this function to specify your organisation's unique OEM compression key
 *
 *	@param[in]	szKey					Your organisation's unique key
 *	@return								NCSError value, NCS_SUCCESS or any applicable error code
 */
void NCS_CALL NCSEcwCompressSetOEMKey(char *szCompanyName, char *szKey);
