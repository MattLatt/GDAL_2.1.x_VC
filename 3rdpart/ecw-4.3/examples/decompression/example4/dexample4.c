...
*
* Use of this product is subject to End-User License Agreement for
* ERDAS Inc. Software.  Use of the examples provided to design, develop,
...
static NCSError NCS_CALL FileOpenCB(char *szFileName, void **ppClientData)
{
	...
	if(NULL != (pData = (MyDataStruct*)malloc(sizeof(MyDataStruct)))) {
		fopen_s(&pData->pFile, szFileName, "rb");
		if(pData->pFile) {
